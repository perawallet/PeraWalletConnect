package app.perawallet.walletconnectv2.test
...
internal class MapperTest {
    ...
    fun testFormattingCAIP222MessageWithNotifyReCaps() {
        val payload = Cacao.Payload(
            ...
            statement = "Statement",
            requestId = null,
            resources = listOf("ipfs://bafybeiemxf5abjwjbikoz4mc3a3dla6ual3jsgpdr4cjr3oz3evfyavhwq/", "https://example.com/my-web2-claim.json", encodedNotifyRecaps)
        )
