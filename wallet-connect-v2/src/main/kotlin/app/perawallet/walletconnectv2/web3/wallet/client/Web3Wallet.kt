...
import app.perawallet.walletconnectv2.CoreInterface
import app.perawallet.walletconnectv2.internal.common.scope
import app.perawallet.walletconnectv2.auth.client.Auth
import app.perawallet.walletconnectv2.auth.client.AuthClient
import app.perawallet.walletconnectv2.auth.common.exceptions.AuthClientAlreadyInitializedException
import app.perawallet.walletconnectv2.sign.client.Sign
import app.perawallet.walletconnectv2.sign.client.SignClient
import app.perawallet.walletconnectv2.sign.common.exceptions.SignClientAlreadyInitializedException
...
object Web3Wallet {
    ...
    fun generateApprovedNamespaces(sessionProposal: Wallet.Model.SessionProposal, supportedNamespaces: Map<String, Wallet.Model.Namespace.Session>): Map<String, Wallet.Model.Namespace.Session> {
        return app.perawallet.walletconnectv2.sign.client.utils.generateApprovedNamespaces(sessionProposal.toSign(), supportedNamespaces.toSign()).toWallet()
    }
    ...
    fun generateAuthObject(payloadParams: Wallet.Model.PayloadAuthRequestParams, issuer: String, signature: Wallet.Model.Cacao.Signature): Wallet.Model.Cacao {
        return app.perawallet.walletconnectv2.sign.client.utils.generateAuthObject(payloadParams.toSign(), issuer, signature.toSign()).toWallet()
    }
    ...
    fun generateAuthPayloadParams(payloadParams: Wallet.Model.PayloadAuthRequestParams, supportedChains: List<String>, supportedMethods: List<String>): Wallet.Model.PayloadAuthRequestParams {
        return app.perawallet.walletconnectv2.sign.client.utils.generateAuthPayloadParams(payloadParams.toSign(), supportedChains, supportedMethods).toWallet()
    }
