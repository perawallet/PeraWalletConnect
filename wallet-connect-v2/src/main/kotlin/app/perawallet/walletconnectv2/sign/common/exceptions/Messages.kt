package app.perawallet.walletconnectv2.sign.common.exceptions
...
internal const val NAMESPACE_METHODS_MISSING_MESSAGE: String = "All required namespaces must be approved: not all methods are approved"
internal const val NAMESPACE_EVENTS_MISSING_MESSAGE: String = "All events must be approved: not all events are approved"
internal const val NAMESPACE_ACCOUNTS_WRONG_NAMESPACE_MESSAGE: String = "Accounts must be defined in matching namespace"
internal const val NAMESPACE_KEYS_MISSING_MESSAGE: String = "All required namespaces must be approved"
