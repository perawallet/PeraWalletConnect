...
import app.perawallet.walletconnectv1.PayloadEncryptionHelper
import app.perawallet.walletconnectv1.Session
import app.perawallet.walletconnectv1.types.extractError
import app.perawallet.walletconnectv1.types.extractSessionParams
import app.perawallet.walletconnectv1.types.getId
import app.perawallet.walletconnectv1.types.intoMap
import app.perawallet.walletconnectv1.types.toSessionRequest
...
abstract class BasePayloadAdapter : Session.PayloadAdapter {
    ...
    private fun Session.MethodCall.Custom.toMap() =
        jsonRpcWithList(id, method, params ?: emptyList<Any>())
